...
class Gemma4AudioCumulativeGroupNorm(nn.Module):
...
class Gemma4TextAltUp(nn.Module):
    ...
    def __init__(self, config: Gemma4TextConfig):
        ...
        self.router_norm = Gemma4RMSNorm(self.config.hidden_size, eps=self.config.rms_norm_eps)
...
class Gemma4PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, Gemma4AudioCumulativeGroupNorm):
        ...
        elif isinstance(module, Gemma4TextModel):
        ...
        elif isinstance(module, Gemma4RotaryEmbedding):
